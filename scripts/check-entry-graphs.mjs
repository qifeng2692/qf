...
const WORKSPACE = {
	"@qf/chord": "packages/chord/src",
	"@qf/pi-ai": "packages/ai/src",
	"@qf/pi-durable": "packages/durable/src",
	"@qf/pi-agent-core": "packages/agent/src",
	"@qf/pi-telemetry": "packages/telemetry/src",
	"@qf/pi-tui": "packages/tui/src",
};
