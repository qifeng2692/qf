...
```bash
npm uninstall -g @qf/pi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @qf/pi-coding-agent`, `yarn global remove @qf/pi-coding-agent`, or `bun uninstall -g @qf/pi-coding-agent`.
