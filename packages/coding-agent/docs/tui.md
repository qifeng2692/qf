...
**Source:** [`@qf/pi-tui`](https://github.com/earendil-works/pi/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@qf/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@qf/pi-tui";
...
Import from `@qf/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@qf/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@qf/pi-tui";
...
```typescript
import { MouseRegion } from "@qf/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@qf/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@qf/pi-coding-agent";
import { Markdown } from "@qf/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@qf/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@qf/pi-coding-agent";
import { DynamicBorder } from "@qf/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@qf/pi-tui";
...
```typescript
import { BorderedLoader } from "@qf/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@qf/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@qf/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@qf/pi-tui";
...
import { matchesKey, truncateToWidth } from "@qf/pi-tui";
