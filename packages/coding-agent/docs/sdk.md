...
```bash
npm install @qf/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@qf/pi-coding-agent";
...
The `Agent` class (from `@qf/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
import { ModelRuntime } from "@qf/pi-coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@qf/pi-ai";
import { createAgentSession, ModelRuntime } from "@qf/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@qf/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@qf/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@qf/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@qf/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@qf/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@qf/pi-coding-agent";
