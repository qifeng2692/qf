...
For TypeScript definitions in your project, inspect `node_modules/@qf/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@qf/pi-coding-agent";
