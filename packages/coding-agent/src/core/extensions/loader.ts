...
import type { Provider } from "@qf/pi-ai";
import type { KeyId } from "@qf/pi-tui";
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@qf/pi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@qf/pi-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@qf/pi-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@qf/pi-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@qf/pi-ai/providers/all");

	_aliases = {
		"@qf/pi-coding-agent": piCodingAgentEntry,
		"@qf/pi-agent-core": piAgentCoreEntry,
		"@qf/pi-tui": piTuiEntry,
		"@qf/pi-ai/providers/all": piAiProvidersEntry,
		"@qf/pi-ai/compat": piAiCompatEntry,
		"@qf/pi-ai/oauth": piAiOauthEntry,
		"@qf/pi-ai": piAiCompatEntry,
