import type { AgentMessage } from "@qf/pi-agent-core";
import { type AssistantMessage, type Model, normalizeContext, type TranscriptContext } from "@qf/pi-ai";
...
vi.mock("@qf/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@qf/pi-ai/compat")>();
	return {
		...actual,
