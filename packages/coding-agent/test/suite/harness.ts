...
import type { FauxModelDefinition, FauxProviderRegistration, FauxResponseStep, Model } from "@qf/pi-ai/compat";
import { registerFauxProvider, streamSimple } from "@qf/pi-ai/compat";
