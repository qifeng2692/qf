...
function assertWorkspace(): void {
	...
	const codingAgentDir = "/repo/node_modules/@qf/pi-coding-agent";
	...
	const internalScope = "/repo/node_modules/@qf";
...
const codingAgentEntry = fileURLToPath(import.meta.resolve("@qf/pi-coding-agent"));
if (codingAgentEntry !== "/repo/node_modules/@qf/pi-coding-agent/dist/index.js") {
